    ...
    for row in range(BOARD_ROWS):
        for col in range(BOARD_COLS):
            if board[row][col] == 1:
                ...
                pygame.draw.line(screen, color, start_desc, end_desc, CROSS_WIDTH)
        ...
        for row in range(BOARD_ROWS):
            for col in range(BOARD_COLS):
                if minimax_board[row][col] == 0:
                    ...
                    score = minimax(minimax_board.copy(), depth + 1, False)
        ...
        for row in range(BOARD_ROWS):
            for col in range(BOARD_COLS):
                if minimax_board[row][col] == 0:
                    ...
                    score = minimax(minimax_board.copy(), depth + 1, True)
                    minimax_board[row][col] = 0
